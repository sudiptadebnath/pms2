<ul class="nav flex-column">
  ...
  <!-- Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="{{ url('user/dashboard') }}"><i class="bi bi-house-door me-2"></i>Dashboard</a>
  </li>
...
@if (hasRole('sa'))
  ...
  <li class="nav-item">
    ...
    <ul class="nav flex-column ms-4">
      <li class="nav-item"><a class="nav-link" href="{{ url('user/users') }}">Users</a></li>
      <li class="nav-item"><a class="nav-link" href="{{ url('user/projects') }}">Projects</a></li>
    </ul>
  </li>
@endif
...
@if (hasRole('sam'))
  ...
  <li class="nav-item">
    ...
    <ul class="nav flex-column ms-4">
      <li class="nav-item"><a class="nav-link" href="{{ url('user/tasks') }}">Tasks</a></li>
    </ul>
  </li>
@endif
...
@if (hasRole('samw'))
  ...
  <li class="nav-item">
    ...
    <ul class="nav flex-column ms-4">
      <li class="nav-item"><a class="nav-link" href="{{ url('user/jobs') }}">Jobs</a></li>
    </ul>
  </li>
@endif
