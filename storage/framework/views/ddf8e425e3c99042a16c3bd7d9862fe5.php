<ul class="nav flex-column">
  ...
  <!-- Dashboard -->
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(url('user/dashboard')); ?>"><i class="bi bi-house-door me-2"></i>Dashboard</a>
  </li>

  <!-- Settings (Always open) -->
<?php if(hasRole('s')): ?>
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('user.settings')); ?>"><i class="bi bi-gear me-2"></i>Settings</a>
  </li>
<?php endif; ?>
